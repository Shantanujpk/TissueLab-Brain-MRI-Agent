This stage is reconstruction (autoencoder), not fully new-brain generation yet.
The next stage is to learn a generative model in the learned latent space for realism.
